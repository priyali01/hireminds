...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060611] text-slate-200 font-sans flex flex-row relative overflow-hidden">
      ...
      {/* LEFT PANEL — fixed 480px, full screen height, scrollable */}
      <motion.div
        initial={{ x: prefersReduced ? 0 : -40, opacity: prefersReduced ? 1 : 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: prefersReduced ? 0.01 : 0.6, ease: 'easeOut' }}
        className="relative z-20 w-[480px] shrink-0 min-h-screen flex items-center justify-center px-8 py-12 border-r border-white/[0.05]"
